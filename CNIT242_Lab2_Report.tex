...
\label{sec:org0e97e87}
\section{Procedures}
\label{sec:orga280179}
...
\label{sec:orgc80c53e}
\subsubsection{1. Install ESXi Servers:}
\label{sec:orgc4fc515}
\begin{itemize}
...
\label{sec:orga7f9632}

\subsubsection{1. Configure SAN Datastore:}
\label{sec:org1335f58}
\begin{itemize}
...
\item Selected an ESXi host (e.g., 44.100.10.91).
...
\label{sec:org12a25ae}
\begin{itemize}
\item Inside vCenter, found Windows 11 VM in the sidebar.
\item Right-clicked and selected \textbf{Migrate}.
\item Chose \textbf{Change compute resource only}.
\item Clicked \textbf{Next}.
\item Selected the target ESXi host (e.g., `44.100.10.92`).
...
\label{sec:org2db55ea}
\section{Results (Sam)}
\label{sec:org83c2be6}
...
\end{itemize}
\item Migration of Windows 10 VM
\begin{itemize}
\item The Windows 10 VM was successfully migrated from VMware Workstation to the ESXi server and added to the inventory.
\end{itemize}
...
\label{sec:org8c3019e}
\centering
\begin{center}
\begin{tabular}{lrrlll}
 & \textbf{ESXi1.2 Server} & \textbf{ESXi2.1 Server} & \textbf{vCenter} & \textbf{Windows 10 VM} & \textbf{Windows 2019 Srv.}\\[0pt]
\hline
...
\restoregeometry
\subsection{Diagrams}
\label{sec:org668d319}
\section{Conclusions}
\label{sec:org9a0f906}
\section{Recommendations}
\label{sec:org0f3174e}
\section{Bibliography}
\label{sec:org439b184}
\end{document}

...
\label{sec:org0da3970}
\section{Procedures}
\label{sec:org4b7b6bd}
...
\label{sec:orga8c4485}
\subsubsection{1. Install ESXi Servers:}
\label{sec:orgedae1bf}
\begin{itemize}
...
\label{sec:org945b87d}
\subsubsection{1. Configure SAN Datastore:}
\label{sec:org8821db0}
\begin{itemize}
...
\label{sec:orgeadf4ba}
\section{Results (Sam)}
\label{sec:orgc3818bd}
...
\end{figure}
\subsection{Diagrams}
\label{sec:orgac7d775}
\section{Conclusions}
\label{sec:org5ab39d0}
\section{Recommendations}
\label{sec:org7f3ccee}
\section{Bibliography}
\label{sec:orgb9aedfe}
\end{document}

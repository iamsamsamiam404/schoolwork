...
\pagestyle{fancy}
\fancyhf{}
\lhead{Lab Report 2 CNIT 242}
\setcounter{tocdepth}{2} % set table of contents to page 2
\author{Group 10}
...
\label{sec:org8c0924c}
\subsubsection{1. Configure SAN Datastore:}
\label{sec:org6c49b8a}
\begin{itemize}
...
\label{sec:org0239a2f}
\subsubsection{Problem Description}
\label{sec:org6ff6b44}
...
\label{sec:org4d924f5}
\subsubsection{Problem Description}
\label{sec:org13e05b1}
...
\label{sec:orgad9136e}
\subsubsection{Problem Description}
\label{sec:org300a99c}

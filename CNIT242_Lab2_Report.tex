...
\label{sec:orgcc1c786}
\subsubsection{1. Configure SAN Datastore:}
\label{sec:org90daddc}
\begin{itemize}
...
\label{sec:orgedb76ce}
\section{Results (Sam)}
\label{sec:orgf8899e4}
...
\end{figure}
\subsection{Diagrams}
\label{sec:org0a984f4}
\section{Conclusions}
\label{sec:org72b65b2}
\section{Recommendations}
\label{sec:orgae4b014}
\section{Bibliography}
\label{sec:org66751d4}
\end{document}
